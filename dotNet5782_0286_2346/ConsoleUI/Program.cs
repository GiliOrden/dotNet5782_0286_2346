...
//                        int.TryParse(Console.ReadLine(), out userChoise);
//                        add = (AddOptions)userChoise;
//                        switch (add)
//                        {
//                            case AddOptions.AddDrone:
//                                dl.AddDrone(addDrone());
//                                break;
//                            case AddOptions.AddStation:
//                                dl.AddStation(addStation());
//                                break;
//                            case AddOptions.AddCustomer:
//                                dl.AddCustomer(addCustomer());
//                                break;
...
//            return d;
//        }
//        public static Station addStation()
//        {
//            int ans;double ans2;
...
namespace ConsoleUI
{
    class Program
    {
        ...
        /// </summary>
        public static void AddingOptions(ref IDal dl)
        {
            int ans;
            double ans2;
            AddOptions add;
